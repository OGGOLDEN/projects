...
public class StudentDirectory {
	...
	public boolean addStudent(String firstName, String lastName, String id, String email, String password, String repeatPassword, int maxCredits) {
		...
		if (maxCredits < Student.MIN_CREDITS || maxCredits > Student.MAX_CREDITS) {
	...
	/**
	 * Gets a Student from the directory using their id
	 * @param id the Student's id
	 * @return a Student with the designated id if they could be found, null otherwise
	 */
