...
public class StudentDirectoryTest {
	...
	public void testLoadStudentsFromFile() {
		...
		//Test invalid file
		try {
			sd.loadStudentsFromFile("invalid test file");
			fail();
	...
	public void testAddStudent() {
		...
		try {
			sd.addStudent(FIRST_NAME, LAST_NAME, ID, EMAIL, "random", PASSWORD, MAX_CREDITS);
			fail();
		} catch(IllegalArgumentException e) {
	...
	public void testSaveStudentDirectory() {
		...
		try {
			...
			assertEquals(e.getMessage(), "Unable to write to file /home/sesmith5/actual_student_records.txt");
		}
	...
	public void testGetStudentById() {
		StudentDirectory sd = new StudentDirectory();
		// Get a student that doesn't exist
		assertEquals(sd.getStudentById("blank"), null);
		...
		Student reference = new Student("Zahir", "King", "zking", "orci.Donec@ametmassaQuisque.com", hashPW, 15);
		assertEquals(sd.getStudentById("zking"), reference);
	}
