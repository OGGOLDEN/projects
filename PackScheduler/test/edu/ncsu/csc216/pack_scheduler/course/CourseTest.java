...
public class CourseTest {
    ...
    public void testCourseStringStringStringIntStringStringIntInt() {
        ...
        try {
            ...
            //assertEquals(ENROLLMENT_CAP, c.getEnrollmentCap());
    ...
    public void testSetName() {
        ...
        c = null;
        try {
            c = new Course("CSC21A", TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLLMENT_CAP, MEETING_DAYS, START_TIME, END_TIME);
            fail();
        } catch (IllegalArgumentException e) {
            assertNull(c);
            assertEquals("Invalid name", e.getMessage());
...
//        }
    ...
    /**
     * Tests compareTo for Course
     */
    @Test
    public void testCompareTo() {
    	Course c1 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLLMENT_CAP, MEETING_DAYS, START_TIME, END_TIME);
    	Course c2 = new Course(NAME, TITLE, "002", CREDITS, INSTRUCTOR_ID, ENROLLMENT_CAP, MEETING_DAYS, START_TIME, END_TIME);
    	Course c3 = new Course("CSC217", TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLLMENT_CAP, MEETING_DAYS, START_TIME, END_TIME);
    	Course c4 = new Course("CSC217", TITLE, "002", CREDITS, INSTRUCTOR_ID, ENROLLMENT_CAP, MEETING_DAYS, START_TIME, END_TIME);
    	...
    	assertEquals(c2.compareTo(c2), 0);
    	assertEquals(c3.compareTo(c3), 0);
